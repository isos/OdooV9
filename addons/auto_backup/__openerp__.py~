...
{
    "name" : "Auto-Backup By Nagarro",
    "version" : "1.0",
    "author" : "Nagarro Software",
    "website" : "http://www.nagarro.com",
...
This module is made and provided by Nagarro Software.
...
5) Heavily compress your backup with tar compression technique if backup it up to a remote location.
""",
    "depends" : ['base'],
    "init_xml" : [],
    "demo_xml" : [],
